...
function Navbar() {
  return (
    ...
    <div className="container mx-auto p-4">
        ...
        rounded-full max-w-[440px] mx-auto flex
        ...
        <Link className="cursor-pointer w-[60px] h-[60px] flex place-content-center place-items-center 
        ...
        <Link className="cursor-pointer w-[60px] h-[60px] flex place-content-center place-items-center 
         hover:bg-violet-600 hover:rounded-full focus-nav" 
        href={"/about"}><SlUser className="w-[25px] h-[25px]"/>
        </Link>
        <Link className="cursor-pointer w-[60px] h-[60px] flex place-content-center place-items-center 
         hover:bg-violet-600 hover:rounded-full focus-nav" 
        href={"/contact"}>
